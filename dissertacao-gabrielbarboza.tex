...
% Permite utilizar a opção float H
\usepackage{float}
...
\include{capitulos/ch2-pinns}
\include{capitulos/ch3-modelos-compartimentais}
% \include{capitulos/ch2-literatura}
\include{capitulos/ch4-proposta}
\include{capitulos/ch5-avaliacao}
\include{capitulos/ch6-conclusoes}
